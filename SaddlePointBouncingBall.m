...
%   Revision: 0.0.0.1 Date: 04/05/2022 5:51:00
...
ku=11;       %Position of optimal cost in u with respect to [1,k]
...
for indexu=1:k
    ...
    for indexw=1:k-4
        ...
        %Terminal Cost
        Jt(size(xt,2))=Jt(size(xt,2))+V([xt(1,size(xt,2)),xt(2,size(xt,2))]);
